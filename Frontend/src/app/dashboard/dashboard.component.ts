...
import { TreeMenuDinamicoComponent } from '../tree-menu-dinamico/tree-menu-dinamico.component';
...
@Component({
    ...
    imports: [HeaderComponent, SideMenuComponent, TreeMenuComponent, TreeMenuDinamicoComponent, TabmenuComponent, ChildComponent, NgIf, AsyncPipe, ErrorComponent, LicitacionesComponent, SeguimientosComponent, SplitterModule]
})
